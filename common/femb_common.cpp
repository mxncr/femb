...
namespace OGF {
    ...
    void femb_libinit::initialize() {

        Logger::out("Init") << "<femb>" << std::endl;

        //_____________________________________________________________

        gom_package_initialize(femb) ;

        ogf_register_grob_commands<OGF::MeshGrob,OGF::MeshGrobFemCommands>();
        ...
        Module::bind_module("femb", module_info);

        Logger::out("Init") << "</femb>" << std::endl;
    }
    
    void femb_libinit::terminate() {
        Logger::out("Init") << "<~femb>" << std::endl;
        //_____________________________________________________________
        ...
        Module::unbind_module("femb");
        Logger::out("Init") << "</~femb>" << std::endl;
    }
    
    femb_libinit::femb_libinit() {
        increment_users();
    }
    ...
    void femb_libinit::increment_users() {
    ...
    void femb_libinit::decrement_users() {
        count_--;
        if(count_ == 0) {
            terminate();
        }
...
extern "C" void femb_API OGF_femb_initialize() {
    OGF::femb_libinit::increment_users();
}

extern "C" void femb_API OGF_femb_terminate() {
    OGF::femb_libinit::decrement_users();
}
